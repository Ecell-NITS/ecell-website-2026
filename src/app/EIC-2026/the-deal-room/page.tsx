      ...
      <main>
        <section className="relative w-full overflow-hidden py-20 lg:py-32">
          <div className="absolute inset-0 z-0">
            ...
            <div className="h-full w-full bg-[url('/images/eic2026/events/deal_room.webp')] bg-cover bg-center opacity-30" />
          </div>
      ...
      <footer className="border-t border-[#cee7d7]/10 bg-[#111111] py-12">
        <div className="mx-auto max-w-7xl px-4 text-center">
          <div className="mb-6 flex items-center justify-center gap-3">
            ...
            <span className="text-lg font-bold">The Deal Room</span>
          </div>
