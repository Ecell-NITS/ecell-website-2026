...
//                     className={`group 3xl:min-h-[650px] 4k:min-h-[750px] relative min-h-[350px] w-full md:min-h-[500px] ${
            ...
            {events.map((event: EventData, idx: number) => (
              ...
              >
                ...
                >
                  ...
                  {/* <button className="group 3xl:px-14 3xl:py-6 relative w-fit overflow-hidden rounded-full border border-blue-500/40 px-10 py-4"> */}
