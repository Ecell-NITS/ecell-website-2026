    ...
    <div className="mx-auto max-w-2xl px-4 pt-8 pb-24 sm:px-6">
      ...
      >
        ...
        <p className="mt-3 text-sm font-light text-gray-500">
          Provide your information to apply for the AI tech team.
        </p>
      </motion.div>
      <div className="relative mt-12">
        ...
        >
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <FormField label="Scholar" required error={errors.scholarId}>
              <input
                className={inputClassName}
            ...
            <FormField label="wa number" required error={errors.whatsappNumber}>
              <input
                className={inputClassName}
