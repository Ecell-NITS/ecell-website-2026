...
export default function TechDomainPage() {
  return (
    <div className="mx-auto max-w-4xl px-4 pt-8 sm:px-6">
      <Link
        href="/recruitment"
        className="mb-12 inline-flex items-center gap-2 text-sm font-medium text-gray-400 transition-colors hover:text-white"
      >
      ...
      >
        <h1 className="text-4xl font-light tracking-tight text-white sm:text-5xl">
          Technical <span className="font-semibold text-gray-300">Domains</span>
        </h1>
        <p className="mt-4 max-w-xl text-sm leading-relaxed font-light text-gray-500">
          Select the engineering discipline you wish to apply for.
        </p>
      </motion.div>
