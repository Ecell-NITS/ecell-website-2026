...
const WHATSAPP_LINKS: Record<string, string> = {
  ...
  "Web Development":
    "https://chat.whatsapp.com/DD2XXKBK1jLKbD4zfwNpfM?s=cl&p=i&ilr=2",
...
function SuccessPageContent() {
  ...
  return (
    <div className="relative flex min-h-[80vh] flex-col items-center justify-center px-4 text-center">
      ...
      <div className="pointer-events-none absolute top-1/2 left-1/2 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-500/10 blur-[100px]" />
      ...
      <div className="relative z-10 w-full max-w-lg">
        ...
        <motion.p
          ...
          className="mt-6 text-base leading-relaxed font-light text-gray-400 sm:text-lg"
        >
          Thank you for applying to E-Cell NIT Silchar. We will review your
          ...
          {selectedTeams.map((team, idx) => {
            ...
            return (
              <a
                ...
                className="group mx-auto flex w-full max-w-md items-center justify-center gap-3 rounded-2xl bg-white px-8 py-4 text-[15px] font-medium text-black shadow-[0_0_20px_rgba(255,255,255,0.1)] transition-all hover:scale-[1.02] hover:bg-gray-100"
              >
                <svg
